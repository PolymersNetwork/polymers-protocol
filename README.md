...
[![Swagger](https://img.shields.io/badge/Swagger-API_Docs-brightgreen)](/docs/swagger.yaml)

**Polymers Protocol** is a production-ready platform integrating **blockchain**, **IoT**, and **ESG** solutions. It provides a seamless experience for wallet management, NFT Twins, payments, recycling analytics, AI assistance, and SmartBin integration.
...
|--------------------|----------------|-----------------------|
| ![Web Dashboard](/public/images/web-dashboard.png) | ![Mobile App](/public/images/mobile-app.png) | ![SmartBin Map](/public/images/smartbin-map.png) |
  ...
  "users": [
    {
      ...
      "createdAt": "2025-09-26T08:01:00Z",
      "role": "user"
    }
  ]
}
...
```json
{
  ...
  "amount": 100,
  "token": "PLY",
  "timestamp": "2025-09-26T08:01:00Z",
  "signature": "5xY...zQw"
}
```
  ...
  "smartbins": [
    {
      ...
      "fillLevel": 75,
      "status": "operational",
      "lastUpdated": "2025-09-26T08:01:00Z"
    }
  ]
}
```
...
```json
{
  ...
  "updatedAt": "2025-09-26T08:01:00Z"
}
```
...
- Full documentation: [View Swagger Docs](/docs/swagger.yaml)  
